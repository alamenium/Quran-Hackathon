...
export const VERSES = {
  ...
  '14:7': {
    verse_key: '14:7',
    text_uthmani: 'وَإِذْ تَأَذَّنَ رَبُّكُمْ لَئِن شَكَرْتُمْ لَأَزِيدَنَّكُمْ ۖ وَلَئِن كَفَرْتُمْ إِنَّ عَذَابِى لَشَدِيدٌ',
    translation:
  ...
  '31:12': {
    verse_key: '31:12',
    text_uthmani: 'وَلَقَدْ ءَاتَيْنَا لُقْمَٰنَ ٱلْحِكْمَةَ أَنِ ٱشْكُرْ لِلَّهِ ۚ وَمَن يَشْكُرْ فَإِنَّمَا يَشْكُرُ لِنَفْسِهِۦ ۖ وَمَن كَفَرَ فَإِنَّ ٱللَّهَ غَنِىٌّ حَمِيدٌ',
    translation:
    ...
    audio_url: audioUrl(31, 12),
    tafsir_simple:
      'Allah gave Luqman wisdom, and the first thing that wisdom led to was gratitude. This ayah teaches us something important: being grateful is not a favour to Allah — it benefits you. Allah does not need our thanks. But we need to practise gratitude to grow, to see blessings, and to feel at peace.',
  },
