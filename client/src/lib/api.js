...
export const api = {
    ...
    // Backward-compatible alias used by the Recite tab.
    // Without this, the built UI crashes with:
    // TypeError: api.recitationStatus is not a function
    recitationStatus: () => request('/api/recitation/asr-status'),
